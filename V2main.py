...
# this is test version for optimization
...
def usage():
  usageInfo = "Usage:\n"\
         + "python3 V2main.py T1T2LabelFilename Epoches HiddenLayerStructure LearningRate\n"\
         + "Notes:\n"\
         ...
         + "6. Usage Example: python3 V2main.py T1T2LabelCubic.csv 10 240,200,160,120,80,40,26 0.002\n"
  print(usageInfo)
